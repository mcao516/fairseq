...
class TranslationTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--abstention-mask-dir',  type=str, default=None,
                            help='directory contains abstention masks')
        # fmt: on
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = load_langpair_dataset(
            ...
            abstention_mask_dir=self.args.abstention_mask_dir
        )
